...
interface SensorControlsProps {
  activeTab: SensorId;
  setActiveTab: (tab: SensorId) => void;
  sensorStates: Record<SensorId, SensorState>;
  setSensorStates: React.Dispatch<React.SetStateAction<Record<SensorId, SensorState>>>;
}

export default function SensorControls({ activeTab, setActiveTab, sensorStates, setSensorStates }: SensorControlsProps) {
